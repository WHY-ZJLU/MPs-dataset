...
if __name__ == '__main__':
    # 图像和标签文件夹
    image_path = r"D:\科研\5.正式实验微塑料检测\VOCdevkit\VOC2007\JPEGImages"
    label_path = r"D:\科研\5.正式实验微塑料检测\VOCdevkit\VOC2007\YOLOLabels"
    save_path = r"C:\Users\13412\Desktop\数据集"  # 结果保存位置路径，可以是一个不存在的文件夹
    # 运行
